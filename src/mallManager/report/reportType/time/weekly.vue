  ...
  methods: {
    ...
    async setEchartsByweek() {
      ...
      let baroption2 = {
        ...
        // legend: {
        //   data: ["用" + this.deviceInfo.Catalog1 + "量"],
        // },
        grid: {
          left: "2%",
          right: "5%",
        ...
        series: [
          {
            // name: "用" + this.deviceInfo.Catalog1 + "量",
            type: "bar",
            data: [],
            markPoint: {
              data: [
